...
Players start with three lives and looses one each time they get an answer wrong.
...
The home screen has a news page at the top to constantly provide relevent news to the users.
...
In the very middle are the two play game types. These will begin the game in either multiplayer or single player.
Once the player runs out of lives, they are shown their score, and the game ends.